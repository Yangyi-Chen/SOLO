...
for shard_id in ${shard_ids[@]}; do
    ...
    DATA_INPUT="/shared/nas/data/m1/yangyic3/Multimodal-Mistral/data/processed/cc3m_full/cc3m_full.shard_${shard_id}.jsonl.lz4"
    OUTPUT_PREFX=data/processed/megatron_format/mmistral_cc3m_full_shard_${shard_id}_pack32k/data
