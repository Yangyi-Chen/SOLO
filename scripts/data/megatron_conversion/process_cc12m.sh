...
for shard_id in ${shard_ids[@]}; do
    ...
    DATA_INPUT="/shared/nas/data/m1/yangyic3/Multimodal-Mistral/data/processed/cc12m/cc12m.shard_${shard_id}.jsonl.lz4"
    OUTPUT_PREFX=/shared/nas/data/m1/xingyao6/projects/Multimodal-Mistral/data/processed/megatron_format/mmistral_cc12m_shard_${shard_id}_pack32k/data
    ...
    if (($RUN_IN_BACKGROUND)); then
        OUTPUT_LOG=logs/data/megatron_format_mmistral_cc12m_shard_${shard_id}_pack32k.log
